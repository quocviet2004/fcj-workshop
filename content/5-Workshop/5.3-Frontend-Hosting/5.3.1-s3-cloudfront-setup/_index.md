...
![Create an Amazon S3 bucket](/images/5-workshop/5.3.1-s3-cloudfront-setup/s3.png)
...
![Upload frontend build files](/images/5-workshop/5.3.1-s3-cloudfront-setup/upload.png)
...
![CloudFront configuration - Step 1](/images/5-workshop/5.3.1-s3-cloudfront-setup/setup1.png)

**Step 2**

![CloudFront configuration - Step 2](/images/5-workshop/5.3.1-s3-cloudfront-setup/setup2.png)

**Step 3**

![CloudFront configuration - Step 3](/images/5-workshop/5.3.1-s3-cloudfront-setup/setup3.png)

**Step 4**

![CloudFront configuration - Step 4](/images/5-workshop/5.3.1-s3-cloudfront-setup/setup4.png)
...
![CloudFront distribution domain name](/images/5-workshop/5.3.1-s3-cloudfront-setup/Distribution.png)